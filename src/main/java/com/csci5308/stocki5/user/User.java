...
public class User implements UserDetails, IUser
{
	...
	public boolean validatePassword()
	{
		...
		if (this.getPassword().equals(this.getConfirmPassword()) == false)
		{
	...
	public boolean validate()
	{
		...
		if (eValidator.isValid(this.getEmailId()) == false)
		{
			this.setValidityMessage(INVALID_EMAIL_MESSAGE);
			return false;
		}

		if (this.getContactNo().matches((CONTACT_NUMBER_PATTERN)) == false)
		{
